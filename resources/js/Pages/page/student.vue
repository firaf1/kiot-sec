                    ...
                    >
                      ...
                      <tbody>
                        <tr v-for="staff in staffs" :key="staff.id" role="row">
                          ...
                          <td class="text-center">
                            <span class="badge outline-badge-primary"> {{ staff.department }} </span>
                          </td>
                          <td class="text-center">
                           <div class="btn-group mb-4 mr-2" v-if="staff.status == 'pending'">

                                                        <button class="btn btn-success btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                           Pending <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                                        </button>
                                                        <div class="dropdown-menu" style="will-change: transform;">
                                                            <a href="javascript:void(0);" class="dropdown-item" @click="ApprovedStudent(staff.id)" >Approved</a>
                                                            <a href="javascript:void(0);" class="dropdown-item" @click="BlockedStudent(staff.id)">Blocked</a>
                                                           
                                                            
                                                        </div>
                                                    </div>

                                                     <div class="btn-group mb-4 mr-2" v-if="staff.status == 'Approved'">

                                                        <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                           Approved <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                                        </button>
                                                        <div class="dropdown-menu" style="will-change: transform;">
                                                            <a href="javascript:void(0);" @click="ApprovedStudent(staff.id)" class="dropdown-item">Approved</a>
                                                            <a href="javascript:void(0);" class="dropdown-item" @click="BlockedStudent(staff.id)">Blocked</a>
                                                    ...
                                                    <div class="btn-group mb-4 mr-2" v-if="staff.status == 'Blocked'">
                                                        ...
                                                        <button class="btn btn-danger btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                           Blocked <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                                        </button>
                                                        <div class="dropdown-menu" style="will-change: transform;">
                                                            <a href="javascript:void(0);" class="dropdown-item" @click="ApprovedStudent(staff.id)" >Approved</a>
                                                            <a href="javascript:void(0);" class="dropdown-item" @click="BlockedStudent(staff.id)">Blocked</a>
