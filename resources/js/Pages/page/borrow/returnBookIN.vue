              ...
              <div class="modal-content">
                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-xl-7 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                      ...
                      <button type="button" @click="SubmitReturn()" class="btn btn-primary">Save</button>
                  </div>
                    </div>
...
props:{
  ...
  document.querySelector('#qr').focus();
    ...
    SubmitReturn(){
      ...
      //  this.isExist = false
      // $('.userInfo').modal('hide');
       Inertia.get(route('ReturnSubmited', this.scannedInfo.id),{
          onStart(){
   ...
   const toast = swal.mixin({
    ...
    qrScanned(){
      ...
      setTimeout(() => { 
        ...
        Inertia.post(route('return.book'), this.form,{
  onStart(){
